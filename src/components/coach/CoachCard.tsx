...
const CATEGORY_META: Record<string, { color: string; rgb: string; label: string }> = {
  ...
  strength:  { color: '#6366F1', rgb: '99,102,241',  label: 'Strength'  },
  goal:      { color: '#60A5FA', rgb: '96,165,250',  label: 'Goal'      },
}
...
export default function CoachCard({ rec }: Props) {
  const cat = CATEGORY_META[rec.category] ?? CATEGORY_META.training
